...
NTPClock::NTPClock(bool DateOnStartup) : isInited(0),
                                         isOnMyPage(0),
...
/**
 * @note After startup, the RTC is running even if the wifi is NOT connected.
 */
...
#endif
        // TODO Add unified exception display
    }
